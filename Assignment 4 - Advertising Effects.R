...
adv_DT[brand_code_uc == 526996, brand_name := "own"]
...
ggplot(data=move_cast, aes(x=normalized_grp, color = "red")) +
  geom_histogram(binwidth = 45, color = "navyblue", fill = "magenta2") + scale_x_continuous(limit=c(-50,300)) + ggtitle("Normalized Own GRP")
